    ...
    c={
        duration:750,show:function(t,e){
            ...
            "touches"in t&&(s=t.touches[0].pageY-r.top,
                ...
                l["-webkit-transform"]=d,l["-moz-transform"]=d,l["-ms-transform"]=d,
                l["-o-transform"]=d,l.transform=d,l.opacity="1",
                ...
                o.setAttribute("style",i(l))},hide:function(t){d.touchup(t);
                    var e=this,
                    n=(1.4*e.clientWidth,null),
                    a=e.getElementsByClassName("waves-ripple");
                    if(!(a.length>0))return!1;n=a[a.length-1];
